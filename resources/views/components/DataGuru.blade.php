        ...
        <div class="p-4 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div class="flex items-center justify-start rounded">
                    <a href="{{ url('dataguru/create') }}"
                        onclick="event.preventDefault(); window.location.href='{{ url('dataguru/create') }}'"
                        class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambah
                        Data Guru</a>
                </div>
