@extends('layouts.app')
@section('title', 'Edit Kelas ' . $class->name_class)
@section('content')
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            @endif
            <div class="mb-4">
                <form action="{{ route('kelas.update', $class->uu_class) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div>
                        ...
                        <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                            Kelas</label>
                        <input type="text" name="name_class" value="{{ $class->name_class }}" id="title"
                    ...
                    <select id="status" name="status"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected value="{{ $class->status }}">
                            @if ($class->status == 0)
                                -Aktif-
                    ...
                    <button onclick="event.preventDefault(); window.location.href='{{ url('kelas') }}'" type="button"
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah kamu yakin
                                        ingin mengubah Kelas <span class="font-semibold">{{ $class->name_class }}?</span>
                                    </h3>
