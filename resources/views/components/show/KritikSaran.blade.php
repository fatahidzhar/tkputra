...
@section('content')
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            <div class="mb-4">
                <div>
                    <input type="text" value="{{ $faqs->name }}" disabled id="title"
                ...
                <div>
                    ...
                    <input type="text" value="{{ $faqs->full_name }}" disabled id="title"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required>
                </div>
                <label for="message" class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white">Kritik &
                    Saran</label>
                <textarea id="message" disabled name="text" rows="4"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $faqs->text }}</textarea>
                <hr class="w-48 h-1 mx-auto my-4 bg-gray-100 border-0 rounded md:my-10 dark:bg-gray-700">
                <form action="{{ route('faq.update', $faqs->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <input type="hidden" value="{{ $faqs->uuid_m ?? 'Tidak ada' }}" name="uuid_m">
                    ...
                    <textarea id="message" name="text_tanggapan" rows="4" required
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $faqs->text_tanggapan }}</textarea>
                    <input type="radio" value="2" name="status" class="hidden">
            </div>
            <div class="mb-5 flex gap-2">
                <div class="flex items-center pl-4 pr-4 border border-gray-200 rounded dark:border-gray-700">
                    <input id="bordered-radio-1" type="radio" value="1" name="status1" {{ old('status1', $faqs->status1) == '1' ? 'checked' : '' }}
                ...
                <div class="flex items-center pl-4 pr-4 border border-gray-200 rounded dark:border-gray-700">
                    <input id="bordered-radio-2" type="radio" value="2" name="status1" {{ old('status1', $faqs->status1) == '2' ? 'checked' : '' }}
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="flex">
                <a href="" onclick="event.preventDefault(); window.location.href='{{ url('kritiksaran') }}'"
