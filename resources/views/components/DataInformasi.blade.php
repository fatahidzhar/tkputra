        ...
        <div class="p-4 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div class="flex items-center justify-start rounded">
                    <a href="" onclick="event.preventDefault(); window.location.href='{{ url('informasi/create') }}'"
                ...
                <div class="relative overflow-x-auto sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        @if (in_array('guru', explode(',', Auth::user()->role)))
                            <tbody>
                                @foreach ($informasi_guru as $item)
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            {{ \Illuminate\Support\Str::limit(strip_tags($item->text), $limit = 50, $end = '...') }}
                                        </td>
                                        <td class="flex px-6 py-4 text-right">
                                            <a href=""
                                                onclick="event.preventDefault(); window.location.href='{{ url('informasi/' . $item->id . '/edit') }}'"
                                                type="button"
                                                class="px-3 py-2 mr-1 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><i
                                                    class="bi bi-pencil-square"></i></a>
                                            <button type="button" data-modal-target="{{ $item->id }}"
                                                data-modal-toggle="{{ $item->id }}"
                                                class="px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"><i
                                                        ...
                                                        <div class="p-6 text-center">
                                                            ...
                                                            <h3
                                                                ...
                                                                Apakah Anda yakin ingin menghapus data <span
                                                                    class="font-semibold">{{ $item->title }}?</span></h3>
