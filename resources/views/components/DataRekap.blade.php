            ...
            <div class="mb-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex mt-5">
                        ...
                        <a href="{{ route('rekap.exportPDFRekap', ['start_date' => $start_date, 'end_date' => $end_date]) }}" target="_blank"
                            class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 ml-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Cetak</a>
                    </div>
                    <div>
